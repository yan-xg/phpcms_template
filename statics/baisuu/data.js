<!-- 
   var CalendarData=new Array(100);var madd=new Array(12);var tgString="¼×ÒÒ±û¶¡Îì¼º¸ýÐÁÈÉ¹ï";var dzString="×Ó³óÒúÃ®³½ËÈÎçÎ´ÉêÓÏÐçº¥";var numString="Ò»¶þÈýËÄÎåÁùÆß°Ë¾ÅÊ®";var monString="Õý¶þÈýËÄÎåÁùÆß°Ë¾ÅÊ®¶¬À°";var weekString="ÈÕÒ»¶þÈýËÄÎåÁù";var sx="ÊóÅ£»¢ÍÃÁúÉßÂíÑòºï¼¦¹·Öí";var cYear,cMonth,cDay,TheDate;
...
tmp+="Äê "; 
if(cMonth<1) { tmp+="(Èò)"; tmp+=monString.charAt(-cMonth-1); } else {tmp+=monString.charAt(cMonth-1);}  tmp+="ÔÂ";  tmp+=(cDay<11)?"³õ":((cDay<20)?"Ê®":((cDay<30)?"Ø¥":"ÈýÊ®")); 
